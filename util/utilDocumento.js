...
], function(jQuery, MessageToast, materialServices, clienteServices, utilString, documentosServices) {
    "use strict";
    return {
        ...
        obtenerInterlocutores: function(self, interlocutores, data) {
            for (var indice in interlocutores) {
                if (interlocutores[indice].Funcion == "AG") {
                    ...
                    self.getView().getModel().setProperty("/interlocutores/" + interlocutores[indice].Funcion, interlocutores[indice]);
                    //self.getView().getModel().setProperty("/interlocutores/" + interlocutores[indice] + "/Cliente/Telefono".Funcion, interlocutores[indice].Cliente.Telefono.split("-")[0]);
                }
            }
            var interAGCliente = self.getView().getModel().getProperty("/interlocutores/AG/Cliente");
            if (interAGCliente.Mail == null || interAGCliente.Mail == "") {
                interAGCliente.Mail = data.objPedido.Mail;
            }
        ...
        obtenerMateriales: function(self, CodTipoDoc, materiales) {
            ...
            for (var indice in materiales) {
                ...
                if (material.CodGrupoMat != null) {
                    ...
                    if (CodTipoDoc == "Z025") {
                        material.PrecioUnitario = material.PrecioSinIGV;
                    }
                    material.Diferencia.Denominacion = " Mat.Diferencia";
                    material.PreZP08.Denominacion = " Pr.Srv.Transp.Manual";
                    //descuentos
                    var listaPrincipal = [{
                        "codigoSer": "DctoDecorPorc"
                    }, {
                        "codigoSer": "DctoGenerico"
                    }, {
                        "codigoSer": "DctoZD11"
                    }, {
                        "codigoSer": "DctoGerenciaPorc"
                    }, {
                        "codigoSer": "DsctoAdicionalZD12"
                    }, {
                        "codigoSer": "Diferencia"
                    }, {
                        "codigoSer": "PreZP08"
                    }, {
                        "codigoSer": "ZP02"
                    ...
                    var listaOtros = [{
                        "codigoSer": "DctoDecorMonto"
                    }, {
                        "codigoSer": "DctoAdicionalPorc"
                    }, {
                        "codigoSer": "DctoEstadisticoPorc"
                    }, {
                        "codigoSer": "DctoGerenciaMonto"
                    }, {
                        "codigoSer": "DctoZD06"
                    }, {
                        "codigoSer": "DctoZD07"
                    }, {
                        "codigoSer": "DctoGenericoZD08"
                    }, {
                        "codigoSer": "DsctoAdicionalZD13"
                    }, {
                        "codigoSer": "Precio"
                    }];
                    var descOtros = this.obtenerDescuento(material, listaOtros);
                    //Ajuste NC
                    if(CodTipoDoc=="Z021" || CodTipoDoc=="Z024"){
                        sessionStorage.setItem("DsctosPrinDocNuevoOriginal"+material.PosicionCorto,JSON.stringify(this.obtenerDescuento(material, listaPrincipal)));
                        sessionStorage.setItem("DsctosOtrosDocNuevoOriginal"+material.PosicionCorto,JSON.stringify(this.obtenerDescuento(material, listaOtros)));
                    }
                    //
        ...
        obtenerDescuento: function(material, descuentos) {
            ...
            for (var indice in descuentos) {
                ...
                if (descuentos[indice].codigoSer == "ZP02") {
                    if (material.Precio.Condicion == "ZP02" && material.Precio.Valor != 0) {} else {
        ...
        validarGuardarDocumento: function(self) {
            var condicion = true;
            //while (condicion) {
                var clientEvent = self.getView().getModel().getProperty("/clienteEventual/esEventual") == "True" ? true : (self.getView().getModel().getProperty("/clienteEventual/esEventual") == "False" ? false : self.getView().getModel().getProperty("/clienteEventual/esEventual"));
                ...
                if (self.getView().getModel().getProperty("/pedido/CodTipoDoc") == 'Z001' ||
                    ...
                    if (ruc != "" || ruc != " ") {
                        //if (ruc.length != 7 && ruc.length != 8 && ruc.length != 9 &&ruc.length != 11)
                ...
                if (self.getView().getModel().getProperty("/listaMaterial/0") == null) {} else {
                ...
                if (canaldist == '10') {
                    if (codDoc == "ZO01" || codDoc == "ZO02" || codDoc == "Z001" ||
                        ...
                        if (self.getView().getModel().getProperty("/interlocutores/AG/Cliente/Ruc").length <= 8 &&
                            clientEvent == true) //Roy: Falta colocar un valor verdadero
                        {
                        ...
                        //SDEC093 OBLIGATORIEDAD CLIENTES CODIFICADOS Y RUCS
                            ...
                            (clientEvent == true ||
                                clientEvent == false)) //Roy: falta colocar valor verdadero
                        {
                ...
                //Inicio Roy 04-06-2018     
                if (self.getView().getModel().getProperty("/pedido/CodTipoDoc") == 'Z003') {
                    if (self.getView().getModel().getProperty("/pedido/OrdenCompra") == "" || self.getView().getModel().getProperty("/pedido/OrdenCompra") == " ") {
                        this.abrirAvisoGeneral(self, "Ingrese Nro. Orden de Compra");
                        condicion = false;
                        return;
                    }
                }
                ...
                if(condicion){
                    if (recordDoc.Flag3 == "") {
                        ...
                        if (cal != 0) {
                            if (self.getView().getModel().getProperty("/pedido/CodTipoDoc") != "ZO01" && self.getView().getModel().getProperty("/pedido/CodTipoDoc") != "ZO02") {
