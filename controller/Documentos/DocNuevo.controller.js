sap.ui.define([
    ...
    "pe/com/seidor/sap/decor/ventas/model/documentoModel"
], function (Controller, Button, Dialog, Text, MessageToast, GroupHeaderListItem, UIComponent, JSONModel, jQuery, utilString, utilFunction, utilDocumento, clienteServices, materialServices, documentosServices, stockServices,documentoModel) {
    "use strict";
    return Controller.extend("pe.com.seidor.sap.decor.ventas.controller.Documentos.DocNuevo", {
        ...
        onRouteMatched: function (oEvent) {
            ...
            if (oEvent.getParameter("name") === "appDocNuevo") {
                ...
                this.getView().setModel(new JSONModel(documentoModel.modelDocNuevo()));
                ///////////////
                ////Inicio Ampliar Listado de Unidad de Medida en el ComboBox////////
                this.getView().setModel(new JSONModel(documentoModel.unidadMedida()),"modellstUnidMed");
                this.getView().getModel("modellstUnidMed").setSizeLimit(700);
                this.getView().getModel("modellstUnidMed").refresh(true);
                ////End Ampliar Listado de Unidad de Medida en el ComboBox////////
                //this.getView().getModel().setProperty("/unidMedida",documentoModel.unidadMedida());
                ///////////////
                ...
                ////////////////////////////////////////////////////////////////////////////
                ////Tipo Despacho///////////////////////////////////////////////////////////
                    var lstDespacho = window.dataIni.lstCondExp.filter(function(el) {
                                         return el.Codigo != "00" && el.Codigo !="06";
                    });
                    window.dataIni.lstCondExp = lstDespacho;
                ////////////////////////////////////////////////////////////////////////////
                ...
                for (var i = 0; i < tiposDoc.length; i++) {
                    if(tiposDoc[i].Codigo !=" " && tiposDoc[i].Codigo !="ZO01" && tiposDoc[i].Codigo !="ZO02"){
                        tiposObject = tiposDoc[i];
                ...
                ///End Boton Multiselect/////////////
                        ...
                        ///////////////////////////////////////////////////
                            ...
                            for (var i = 0; i < sap.ui.getCore().byId("ListaDocNuevo").getItems().length; i++) {
                                var pathTipoDoc = sap.ui.getCore().byId("ListaDocNuevo").getItems()[i].getBindingContext().getPath();
                                var itemTipoDoc = this.getView().getModel().getProperty(pathTipoDoc);
                                if(itemTipoDoc.Codigo=="ZO01"){
                                    var firstItem = sap.ui.getCore().byId("ListaDocNuevo").getItems()[i]; 
                                    sap.ui.getCore().byId("ListaDocNuevo").setSelectedItem(firstItem,true);
                                }
                            }
                            //
                            /*
                            if(window.crearPedido == true){
                                var firstItem = sap.ui.getCore().byId("ListaDocNuevo").getItems()[19]; //ponerlo 19 en la posicion Z001
                            sap.ui.getCore().byId("ListaDocNuevo").setSelectedItem(firstItem,true);
                            }else{
                                var firstItem = sap.ui.getCore().byId("ListaDocNuevo").getItems()[19]; //ponerlo en la posicion ZO01
                            sap.ui.getCore().byId("ListaDocNuevo").setSelectedItem(firstItem,true);
                            }
                            */
                            var tituloDocNuevo = sessionStorage.tituloDocumentoDocNuevo==undefined || sessionStorage.tituloDocumentoDocNuevo=="undefined"? "":JSON.parse(sessionStorage.tituloDocumentoDocNuevo);
                            if(tituloDocNuevo==""){
                                ...
                                sap.ui.getCore().byId("dlg_DialogDocNuevo").open();
                                    ...
                                    this.getView().getModel().setProperty("/pedido",JSON.parse((sessionStorage.pedidoDocNuevo==undefined)? "":sessionStorage.pedidoDocNuevo));
                                    this.getView().getModel().setProperty("/listaMaterial",JSON.parse((sessionStorage.listaMaterialDocNuevo==undefined)? "":sessionStorage.listaMaterialDocNuevo));

                                    ///////
                                        //this.getView().byId("claseMaterial").aCustomStyleClasses[0]="listaMatVerde";
                                        //this.getView().byId("claseMaterial").mCustomStyleClassMap.listaMatVerde = true;
                                    //////
                                    
                                    this.getView().getModel().setProperty("/interlocutores",JSON.parse((sessionStorage.interlocutoresDocNuevo==undefined)? "":sessionStorage.interlocutoresDocNuevo));
                                    
                                    this.getView().getModel().setProperty("/tipoDocEscogido",JSON.parse((sessionStorage.tipoDocEscogidoDocNuevo==undefined)? "":sessionStorage.tipoDocEscogidoDocNuevo));
                                    this.getView().getModel().setProperty("/tituloDocumento",JSON.parse((sessionStorage.tituloDocumentoDocNuevo==undefined)? "":sessionStorage.tituloDocumentoDocNuevo));
                                    if(sessionStorage.NumeroDocumentoReferenciaDocNuevo=="undefined"){
                                        sessionStorage.setItem("NumeroDocumentoReferenciaDocNuevo", JSON.stringify(""));
                                    }
                                    this.getView().getModel().setProperty("/NumeroDocumentoReferencia",JSON.parse((sessionStorage.NumeroDocumentoReferenciaDocNuevo==undefined)? "":sessionStorage.NumeroDocumentoReferenciaDocNuevo));
                                    this.getView().getModel().setProperty("/listaLinea",JSON.parse((sessionStorage.listaLineaDocNuevo==undefined)? "":sessionStorage.listaLineaDocNuevo));
                                    this.getView().getModel().setProperty("/listaMarca",JSON.parse((sessionStorage.listaMarcaDocNuevo==undefined)? "":sessionStorage.listaMarcaDocNuevo));
                                    this.getView().getModel().setProperty("/listacaract",JSON.parse((sessionStorage.listacaractDocNuevo==undefined)? "":sessionStorage.listacaractDocNuevo));
                                    this.getView().getModel().setProperty("/documentoNuevo",JSON.parse((sessionStorage.documentoNuevoDocNuevo==undefined)? "":sessionStorage.documentoNuevoDocNuevo));
                                    
                                    this.getView().getModel().setProperty("/observaciones",JSON.parse((sessionStorage.observacionesDocNuevo==undefined)? "":sessionStorage.observacionesDocNuevo));
                                    
                                    this.getView().getModel().setProperty("/cliente",JSON.parse((sessionStorage.clienteDocNuevo==undefined)? "":sessionStorage.clienteDocNuevo));
                                    this.getView().getModel().setProperty("/clienteEventual",JSON.parse((sessionStorage.clienteEventualDocNuevo==undefined)? "":sessionStorage.clienteEventualDocNuevo));
                                    this.getView().getModel().setProperty("/preguntas",JSON.parse((sessionStorage.preguntasDocNuevo==undefined)? "":sessionStorage.preguntasDocNuevo));
                                    
                                    this.getView().getModel().setProperty("/busquedaCliente",JSON.parse((sessionStorage.busquedaClienteDocNuevo==undefined)? "":sessionStorage.busquedaClienteDocNuevo));
                                    this.getView().getModel().setProperty("/planFacturacion",JSON.parse((sessionStorage.planFacturacionDocNuevo==undefined)? "":sessionStorage.planFacturacionDocNuevo));
                                    this.getView().getModel().setProperty("/visita",JSON.parse((sessionStorage.visitaDocNuevo==undefined)? "":sessionStorage.visitaDocNuevo));
                                    
                                    /*this.getView().getModel().setProperty("/lstGrupoForAnt",JSON.parse((sessionStorage.lstGrupoForAntDocNuevo==undefined)? "":sessionStorage.lstGrupoForAntDocNuevo));
                                    this.getView().getModel().setProperty("/lstGrupoFor",JSON.parse((sessionStorage.lstGrupoForDocNuevo==undefined)? "":sessionStorage.lstGrupoForDocNuevo));
                                    this.getView().getModel().setProperty("/lstTipoFor",JSON.parse((sessionStorage.lstTipoForDocNuevo==undefined)? "":sessionStorage.lstTipoForDocNuevo));*/
                                    this.getView().getModel().setProperty("/lstGrupoForAnt",(sessionStorage.lstGrupoForAntDocNuevo==undefined || sessionStorage.lstGrupoForAntDocNuevo=="undefined")? "":JSON.parse(sessionStorage.lstGrupoForAntDocNuevo));
                                    this.getView().getModel().setProperty("/lstGrupoFor",(sessionStorage.lstGrupoForDocNuevo==undefined || sessionStorage.lstGrupoForDocNuevo=="undefined")? "":JSON.parse(sessionStorage.lstGrupoForDocNuevo));
                                    this.getView().getModel().setProperty("/lstTipoFor",(sessionStorage.lstTipoForDocNuevo==undefined || sessionStorage.lstTipoForDocNuevo=="undefined")? "":JSON.parse(sessionStorage.lstTipoForDocNuevo));
                           ...
                           /* window.prueba = [
                            ...
                            this.getView().getModel().setProperty("/prueba2", window.prueba);
                            ...
                            var pressDialog = new Dialog({
                                ...
                                endButton: [new Button({
                                    text: this.getView().getModel().getProperty("/dataIni/lstMoneda/1/Codigo"),
                                    press:function(){
                                        this.onOkDlg_DialogDocNuevo();
                                    }
                                })]
                            });
        ...
        sessionStorageDocNuevo: function(){
            sessionStorage.setItem("tipoDocEscogidoDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/tipoDocEscogido")));
            sessionStorage.setItem("tituloDocumentoDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/tituloDocumento")));
            sessionStorage.setItem("NumeroDocumentoReferenciaDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/NumeroDocumentoReferencia")));
            sessionStorage.setItem("listaLineaDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/listaLinea")));
            sessionStorage.setItem("listaMarcaDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/listaMarca")));
            sessionStorage.setItem("listacaractDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/listacaract")));
            sessionStorage.setItem("documentoNuevoDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/documentoNuevo")));
            sessionStorage.setItem("pedidoDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/pedido")));
            sessionStorage.setItem("observacionesDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/observaciones")));
            sessionStorage.setItem("interlocutoresDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/interlocutores")));
            sessionStorage.setItem("clienteDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/cliente")));
            sessionStorage.setItem("clienteEventualDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/clienteEventual")));
            sessionStorage.setItem("preguntasDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/preguntas")));
            sessionStorage.setItem("listaMaterialDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/listaMaterial")));
            sessionStorage.setItem("busquedaClienteDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/busquedaCliente")));
            sessionStorage.setItem("planFacturacionDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/planFacturacion")));
            sessionStorage.setItem("visitaDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/visita")));
            sessionStorage.setItem("lstGrupoForAntDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/lstGrupoForAnt")));
            sessionStorage.setItem("lstGrupoForDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/lstGrupoFor")));
            sessionStorage.setItem("lstTipoForDocNuevo",JSON.stringify(this.getView().getModel().getProperty("/lstTipoFor")));
        ...
        validacionBotones:function(CodTipoDoc){
            ...
            ///Inicio Buscar Codigo Antiguo///////////////////////////////
            if( (CodTipoDoc!="Z035" && CodTipoDoc!="Z036" && CodTipoDoc!="Z037" && 
                CodTipoDoc!="Z038" ) && window.dataIni.person.CanalDist=="10"){
                sap.ui.getCore().byId("txt_codigo_proveedor").setEnabled(true);
            }else{
                sap.ui.getCore().byId("txt_codigo_proveedor").setEnabled(false);
            }
            ///End Buscar Codigo Antiguo//////////////////////////////////
        },   
        initView: function () {
            if(sessionStorage.listaMaterialDocNuevo==undefined){
        ...
        onOkDlg_DialogDocNuevo: function (oEvent) {
            var tipoDocumento = sap.ui.getCore().byId("ListaDocNuevo").getSelectedItem().getBindingContext().getObject();
            ///////Inicio Roy Tipo Documento/////////////////////////////////////////////////
            this.getView().getModel().setProperty("/documentoNuevo",tipoDocumento);
            this.getView().getModel().refresh();
            var titulo = "Creando Documento "+this.getView().getModel().getProperty("/documentoNuevo/Codigo");
            this.getView().getModel().setProperty("/tituloDocumento",titulo);
            //window.tituloPrincipalShell = titulo;
            var titulo2 = this.getView().getModel().getProperty("/tituloDocumento");
                    
            ///////End Roy Tipo Documento////////////////////////////////////////////////////
            var tipoDocCodigo = tipoDocumento.Codigo;
            var referencia = sap.ui.getCore().byId("txt_refDocNuevo").getValue();
            ...
            var tipo_visita = sap.ui.getCore().byId("cbo_tipo_visita").getSelectedKey();
            ...
            if(referencia != "") {
                ...
                //////Nueva Valid/////////////////////////////////////////////////////////////////
                if ( tipoDocCodigo == "Z036" && tipo_visita=="") 
                    {
                        sap.m.MessageToast.show('Debe ingresar tipo de visita', { duration: 3000 }); 
                        return; 
                    }
                //////////////////////////////////////////////////////////////////////////////////
                ...
                if(tipo_visita!= "")
                {
                    if (tipoDocCodigo == "Z036" && referencia=="" && tipo_visita=="01") 
                    {
                        sap.m.MessageToast.show('Debe ingresar referencia', { duration: 3000 }); 
                    }else{
                        console.log("TIPO VISITA",tipo_visita);
            ...
            ///Inicio Agregar ListaMaster///////////////////////////////////
             ...
             tab7        listPanelDatosServicio*/
                    ...
                    this.creacionMaster(tipoDocCodigo);
        ...
        validOpcionAmbiente:function(){
            if(window.dataIni.person.CanalDist=="10"){
                if( this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z036" || 
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z010" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z035" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="ZO02" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z003" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z004" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z015" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z034" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z037" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z038" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z040"){
    ...
    validCamposProfesionales:function(){
        if(window.dataIni.person.CanalDist=='10'){
            if(this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="ZO01" ||
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="ZO02" ){
...
setTimeout(function () {
            var tipoDoc = self.getView().getModel().getProperty("/documentoNuevo");
            if(referencia!=""){
                var accion = "copiar";
            }else{
                var accion = "";
            ...
            documentosServices.visualizarDocumento(tipoDoc.Codigo,accion, referencia, function(result) { 
            ...
            try{
                ...
                if (result.data.success) {
                    ...
                    self.validacionBotones(tipoDoc.Codigo); 
                    ...
                    /////Inicio Buscar Cliente Codificado//////////////////////////////////////////////////////
                        if(parseInt(data.codigoCliente).toString().length==10){
                        //self.obtenerDatosInterlocutorCliente(data.codigoCliente);
                        clienteServices.buscarClienteCodigo(data.codigoCliente, data.codigoCliente, datosTienda.CanalDist, function(result) {
                            if (result.c == "s") {
                                var data = result.data;
                                data.lstGrupoFor;
                                self.getView().getModel().setProperty("/lstGrupoFor", data.lstGrupoFor);
                    ...
                    if(data.objPedido.CodTipoDoc == 'ZO02' && data.PedidoVisita42 != '') {
                        ...
                        self.crearDialogAvisoTipoDocumento(data);
                    } else {
                    ...
                    ///Inicio Valid Ped. Viaticos/////////////////////////////////////////////////////
                        if(tipoDoc.Codigo=="Z040" || tipoDoc.Codigo=="Z015"){
                            self.getView().getModel().setProperty("/listaMaterial",null);
                            self.getView().getModel().setProperty("/pedido/Total","");
                            self.getView().getModel().setProperty("/pedido/TotalDcto","");
                        }
                    ///End Valid Ped. Viaticos///////////////////////////////////////////////////////   
                    window.numeroDocumento="";
                    self.validOpcionAmbiente();
                    self.validCamposProfesionales();
                    self.validMaterialesPorDefecto();
                    self.validMotivoNc();
                    self.validCamposDoc();
                    self.sessionStorageDocNuevo();                
                } else {
        ...
        validMaterialesPorDefecto:function(){
            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z036" ){
                sap.ui.getCore().byId("txt_codigo_anadir_material").setValue("20000701") ;
                sap.ui.getCore().byId("txt_cantidad_anadir_material").setValue("1") ;
                this.onDocNuevoMasterProductosAdd();
            }
            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z015" ){
                //this.getView().byId("com_opcion_anadir_material").getSelectedKey();
                //this.getView().byId("com_ambiente_anadir_material").getSelectedKey() ;
                sap.ui.getCore().byId("txt_codigo_anadir_material").setValue("20000182") ;
                sap.ui.getCore().byId("txt_cantidad_anadir_material").setValue("1") ;
                this.onDocNuevoMasterProductosAdd();
            }
            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z040" ){
                //this.getView().byId("com_opcion_anadir_material").getSelectedKey();
                //this.getView().byId("com_ambiente_anadir_material").getSelectedKey() ;
                sap.ui.getCore().byId("txt_codigo_anadir_material").setValue("20000514") ;
                sap.ui.getCore().byId("txt_cantidad_anadir_material").setValue("1") ;
                this.onDocNuevoMasterProductosAdd();
            }
            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z035" ){
                //this.getView().byId("com_opcion_anadir_material").getSelectedKey();
                //this.getView().byId("com_ambiente_anadir_material").getSelectedKey() ;
                sap.ui.getCore().byId("txt_codigo_anadir_material").setValue("20000812") ;
                sap.ui.getCore().byId("txt_cantidad_anadir_material").setValue("1") ;
                this.onDocNuevoMasterProductosAdd();
            }
        },
        initDataProyecto: function (data, lstGrupoFor, lstTipoFor) {
            ...
            pedido.CodTipoDoc= pedidoSer.CodTipoDoc;
                ...
                ////Cuando está activo el combo Tipo Visita de Dlg_inicioDoc/////////////
                if( sap.ui.getCore().byId("cbo_tipo_visita").getEnabled()==true ){
        ...
        sap.ui.core.BusyIndicator.show(0);
            ...
            documentosServices.crearDocumentoCallback(codTipoDocuemnto, referencia, function(result) {
                 sap.ui.core.BusyIndicator.hide();
                 if (result.c === "s") {
                    if (result.data.success) {
                        window.numeroDocumento="";
                        self.initDataDefault(result.data, codTipoDocuemnto);
                        self.validacionBotones(codTipoDocuemnto);
                        MessageToast.show(self.getView().getModel().getProperty("/documentoNuevo/Descripcion"));
                        self.validMaterialesPorDefecto();
                        self.validOpcionAmbiente();
                        self.validCamposDoc();
                        self.validCamposProfesionales();
        ...
        initDataDefault: function (data, codigo) {   
            ...
            pedido.OrgVentas = datosTienda.OrgVentas=="" ? "1000" : datosTienda.OrgVentas;//03-07-2018
            pedido.CanalDist = datosTienda.CanalDist=="" ? "90" : datosTienda.CanalDist;//03-07-2018
            pedido.TipoCambio = data.tipoCambio;
           ...
           this.getView().getModel().setProperty("/lstGrupoForAnt", data.lstGrupoFor);
            ...
            if(listaGroup.length>1){
                if(datosTienda.CanalDist=="20"&&datosTienda.OfVentas=="1130")
                {
                   this.getView().getModel().setProperty("/pedido/GrupoForecast",listaGroup[2].Codigo);         
                }
                else
                {
                   this.getView().getModel().setProperty("/pedido/GrupoForecast",listaGroup[1].Codigo);          
                }

                this.getView().getModel().setProperty("/lstTipoFor", data.lstTipoFor);
                window.lstTipoFor = this.getView().getModel().getProperty("/lstTipoFor");
                window.lstTipoForOriginal = this.getView().getModel().getProperty("/lstTipoFor");
                var tipoFore1 = window.lstTipoForOriginal;
                                        var tipoForeFormateado1 = tipoFore1.filter(function(el) {
                                             return el.Codigo == "00" || el.Codigo == " ";
                                        });
                                        this.getView().getModel().setProperty("/lstTipoFor", tipoForeFormateado1);
                                        this.getView().getModel().setProperty("/GrupoForeAction",true);
                                        this.getView().getModel().setProperty("/TipoForeAction",true);
                                        this.getView().getModel().setProperty("/pedido/TipoForecast"," ");
                if (listaGroup[1].Codigo=="06"&& listaGroup[1].canal=="30") {
                    this.getView().getModel().setProperty("/pedido/TipoForecast","00");
                }
                else{
                    this.getView().getModel().setProperty("/pedido/TipoForecast"," ");
                }
        ...
        onBuscarInterlocutores: function () {
            ...
            this.sessionStorageDocNuevo();
            var fg = this.getView().getModel().getProperty("/interlocutores");
        },
        ...
        obtenerDatosInterlocutorCliente: function (codigoClienteA) {
            ...
            setTimeout(function () {
                ...
                ///////Inicio Canal 20/////////////////////////////////////////////////////////////////
                            ...
                            if(window.dataIni.person.CanalDist=='30'){
                                    self.getView().getModel().setProperty("/pedido/GrupoForecast",lstGrupoForFiltrado[1].Codigo);
                                    //self.getView().getModel().setProperty("/GrupoForeAction",true);
                                    //self.getView().getModel().setProperty("/TipoForeAction",true);
                                    self.onSeleccionarGrupoForecast();
                                    self.getView().getModel().setProperty("/pedido/TipoForecast"," ");
                            }
                            ///////End Canal 30////////////////////////////////////////////////////////////////////////
        ...
        obtenerDatosInterlocutorNombre: function (codigoCliente, tipoInterlocutor) {
            ...
            setTimeout(function () {
                ...
                }catch(ex){sap.ui.core.BusyIndicator.hide();}
        ...
        crearDetalleEmpresa:function(busquedaDTO){
            ...
            var ciudad = jQuery.grep(ubigeo, function(item, i){ 
                          return (item.Codigo == busquedaDTO.distrito) ;
                        });
            
        var objEmpresa={"id":1,
                            "PedidoId":0,
                            "Funcion":"AG",
                            "Codigo":this.getView().getModel().getProperty("/clienteEventual/codigoCliente") ,
                            "Ruc":busquedaDTO.ruc,
                            "Descripcion":busquedaDTO.descripcion,
                            "Titulo":"",
                            "Direccion":busquedaDTO.direccion,
                            "DireccionCompleta":"",
                            "Ciudad":ciudad.length>0 ? ciudad[0].Descripcion: "",
                            "Pais":"",
                            "CodigoPostal":busquedaDTO.distrito,
                            "Distrito":ciudad.length>0 ? ciudad[0].Descripcion: "",
        ...
        var empresa = {"Codigo": this.getView().getModel().getProperty("/clienteEventual/codigoCliente"),
                            "Ruc": busquedaDTO.ruc,
                            "Descripcion": busquedaDTO.descripcion,
                            "Direccion": busquedaDTO.direccion,
                            "CodigoPostal": busquedaDTO.distrito,
...
setTimeout(function () {
                ...
                if (result.c === "s" && !jQuery.isEmptyObject(cliente)) {
                    ...
                    self.getView().getModel().refresh();    
                        ...
                        //var validCliente = self.validarCliente(solicitante.codigo);
                            ...
                            ///////Inicio Canal 10/////////////////////////////////////////////////////////////////
                    if(window.dataIni.person.CanalDist=='10' || window.dataIni.person.CanalDist=='40'){
                                if(grupo_for!="01"){
                                    ///////Formateo Tipo Forecast///////////////////////
                                    var tipoFore = self.getView().getModel().getProperty("/lstTipoFor");
                                    var tipoForeFormateado = tipoFore.filter(function(el) {
                    ...
                    interlocutorAG.Cliente.Direccion= (cliente.DIREC != null) ? cliente.DIREC : "";                  
                    interlocutorAG.Cliente.CodigoPostal= (cliente.CodigoPostal != null) ? cliente.CodigoPostal : "";
                    interlocutorAG.Cliente.Ciudad= ciudad.length>0 ? ciudad[0].Descripcion : "";  
                    interlocutorAG.Cliente.Distrito= ciudad.length>0 ? ciudad[0].Descripcion: "";             
                    interlocutorAG.Cliente.Mail= (cliente.Mail != null) ? cliente.Mail : "";                    
                    interlocutorAG.Cliente.Telefono= (cliente.Telefono != null) ? cliente.Telefono : "";
                    self.getView().getModel().setProperty("/interlocutores/AG", interlocutorAG);
            ...
            /*//Grabar Ruc
            var crearEmpresa = self.crearEmpresa(busquedaDTO);
                    //var result = documentosServices.buscarmaterial(datosMateriales);
                                documentosServices.grabarRuc(crearEmpresa, function(result) { 
                                    sap.ui.core.BusyIndicator.hide();
                                if (result.c === "s") {
        ...
        onDocNuevoCloseSeleccionarProfesional1: function () {
            sap.ui.getCore().byId("dlg_DocNuevobuscarProfesional_resultado1").close();
        },
        onDocNuevoCloseSeleccionarProfesional2: function () {
            sap.ui.getCore().byId("dlg_DocNuevobuscarProfesional_resultado2").close();
        },
        ...
        if(this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z036" && 
                this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z010" &&
                    ...
                    this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z037" &&
                    this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z038" &&
                    this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z036" &&
                    this.getView().getModel().getProperty("/documentoNuevo/Codigo")!="Z040"){
        ...
        var self = this;
                    ...
                    var tamanoList = self.obtenerTamaniolLista();
                    var nuevoMaterial = self.crearNuevoMaterial(codigoMaterial, opcionMaterial, codigoAmbiente, cantidad, tamanoList);
                        ...
                        var url = window.RootServices + "material.aspx";
                        
                        var parametros = {};
                        parametros = nuevoMaterial; 
                        parametros.UserId = window.dataIni.user.User;
                        parametros.servicio = "materialServices.anadirMaterialMaster()";
        ...
        onBtnRecalcular:function(){
            ...
            if(materiales){
                if(materiales.length > 0) {
                    ...
                    var dsctoLotes = 2;
                    var listaDscto = JSON.stringify(this.crearDescuentos());// JSON.stringify(this.crearDescuentos());
                    var listaInter = JSON.stringify(this.crearInterlocutores());
                    var listaRepartos = JSON.stringify(this.crearRepartos());
                    var listaMateriales = JSON.stringify(this.crearMateriales());// JSON.stringify(this.crearMateriales());   //crearMateriales1          
...
setTimeout(function () {
        ...
        agregarMaterialNuevo: function (materialSer,stockSer,cantidad,fecTransito) {//Modificado Roy            
            ...
            for(var indice in materialSer) {            
                ...
                if(window.dataIni.person.CanalDist==10){
                    if(indice!="0"){
                        if(materialSer.length>1){
                            if(materialSer[indice].FlagCantPadre=="X"){
                            material.Cantidad = materialSer["0"].Cantidad;   //*Revisar ya que al agregar 1 cantidad de el material 11000008 retorna 2.1 de este y 3 de los demas*
                            }else{
                                material.Cantidad = materialSer[indice].Cantidad;
                            }
                        }
                    }else{
                        material.Cantidad = materialSer[indice].Cantidad;
                ...
                ///////Detalle Lista Material Principal/////////////
                /*var  usu_ser = window.dataIni.person.UsuarioServ;
                if(usu_ser=="X"){
                    material.detMaterial2 = "\n Dscto: " + material.Vdscto+ " %" + 
                                            "\n Peso TotaL: " + material.Peso+ " - " + "Tipo Mat: " + material.TipoMaterial + " - Tipo Pos: " + material.TipoPosicion +
                                            "\n Prioridad Ent.: " +  material.PrioridadEntrega + " - " + material.Repartos[0].FechaEntrega + " - Ambiente: " + material.DesGrupoMat + " - Opcion: " + material.Opcion ; 
                }else{
                    material.detMaterial2 = "\n Precio Unit. C/IGV C/DSCTO: " +  material.PrecConIgv + " - Total C/IGV: " +  material.Total + " - Dscto: "+ material.Vdscto+ " %"+ 
                                            "\n Peso TotaL: " + material.Peso+ " - Tipo Mat: " + material.TipoMaterial + " - Tipo Pos: " + material.TipoPosicion +
                                            "\n Prioridad Ent.: " +  material.PrioridadEntrega + " - " + material.Repartos[0].FechaEntrega + " - Ambiente: " + material.DesGrupoMat + " - Opcion: " + material.Opcion +
                                            "\n" + material.Descontinuado ;
                }*/
                ///////End Detale Lista Material Principal//////////
        ...
        crearPedidoConReferencia: function() {
            ...
            pedido.Moneda = pedidoMod.Moneda;//"PEN";//pedidoMod.Moneda;//CAMBIO
            ...
            pedido.TieneEntrega = false;//false;
            pedido.DocOriginal = (pedidoMod.NumPedido!="") ? pedidoMod.DocOriginal : "" ;//"";
            ...
            pedido.FechaResult = null; //fecha_resultado;
        ...
        crearPedido: function() {
           ...
           cliente.P55 = clienteMod.P55 ; // null
            ...
            pedido.CodGrupoVend = pedidoMod.CodGrupoVend;//"";//pedidoMod.CodGrupoVend;
            pedido.Sector = pedidoMod.Sector;//"";
            pedido.SubTotal  =  (pedidoMod.SubTotal==null || pedidoMod.SubTotal=="") ? 0:parseFloat(pedidoMod.SubTotal); //*
            pedido.Igv  =  (pedidoMod.Igv==null || pedidoMod.Igv=="" ) ? 0:parseFloat(pedidoMod.Igv); //*
            pedido.Total  =  (pedidoMod.Total==null || pedidoMod.Total=="") ? 0:parseFloat(pedidoMod.Total); //*
            pedido.TotalImp  =  (pedidoMod.TotalImp ==null || pedidoMod.TotalImp =="") ? 0:parseFloat(pedidoMod.TotalImp); //*
            pedido.PesoTotal = (pedidoMod.PesoTotal!="") ? pedidoMod.PesoTotal : 0;//0;//(pedidoMod.PesoTotal!= "") ? pedidoMod.PesoTotal : 0;
            pedido.GrupoCond = pedidoMod.GrupoCond;//"";
            pedido.Tratado = false;//false;
            pedido.ClasePedidoCliente = "";//"";
            ...
            pedido.textoResultadoVisita = this.getView().getModel().getProperty("/observaciones/ZP11/Descripcion");//"";//visitaMod.textoResultadoVisita;
            pedido.textoDescripcionServInstalacion = this.getView().getModel().getProperty("/observaciones/ZP14/Descripcion");//"";
            pedido.FechaResult = this.getView().getModel().getProperty("/observaciones/ZP15/Descripcion");
            if(pedidoMod.NumPedido!=""){
                ...
                if(listaPrincipal != undefined && listaOtros != undefined) {
                    ...
                    for(var indice in descuentosOriginales) {
                        ...
                        if(buscarDscto.length>0){
                            ...
                            buscarDscto[0].matPosicion = parseInt(posicion); 
                            buscarDscto[0].Moneda = "";
                            buscarDscto[0].iconBtnCalcular = "";
                            listaDescuentos.push(buscarDscto[0]);
                        }else{
                            descuentosOriginales[indice].Moneda = "";
                            descuentosOriginales[indice].iconBtnCalcular = "";
                            descuentosOriginales[indice].matPosicion = descuentosOriginales[indice].matPosicion;
                            listaDescuentos.push(descuentosOriginales[indice]);
                        }
        ...
        crearInterlocutores: function() {
            ...
            for(var indice in listInter) {
                ...
                interlocutor.Ciudad = ciudad.length>0 ? ciudad[0].Descripcion: ""; //this.getView().byId("com_distrito_solicitante").getSelectedItem().getText();
        ...
        onGuardarDetalleMaterial: function() {
            ...
            ////////Roy Desaparecer Repartos y convertirlo en 1 solo al colocar una cantidad menor/////////////
                    var repartos = material.Repartos;
                    var cantidadReparto = 0;
                    for(var indice in repartos) {
                        cantidadReparto = cantidadReparto + parseInt(repartos[indice].CantPed);
                    ...
                    for(var indice in listaDescuentos) {
                        ...
                        if (descuento.Importe != 0 && condicion == "ZD") {
                            if (descuento.Condicion == 'ZD09' && material.Cantidad != materialMod.Cantidad) {
                                ...
                                acumulado = acumulado + parseFloat(descuento.Importe);
                            }
                        }
                        if(descuento.condicion =="ZP08" || descuento.condicion =="ZP01" || descuento.condicion =="ZP02"){
                            dsctoManuales = 1;
        ...
        var nuevoDocumento = new Object();
            ...
            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z035"){
                nuevoDocumento.pPedTotal=(pedido.Total==null)?0:pedido.Total;
            }else{
                nuevoDocumento.pPedTotal=null;
            }
        ...
        validObservaciones:function(){
           ...
           onBtnGuardarDocumento:function(){
            //utilDocumento.setValidInterlocutores(this);
            this.validObservaciones();
            this.getView().getModel().refresh();
            utilDocumento.validarGuardarDocumento(this);
            var Ciudad = this.getView().byId("com_distrito_solicitante").getSelectedItem().getText();
            this.getView().getModel().setProperty("/interlocutores/AG/Cliente/Ciudad",Ciudad);
            this.getView().getModel().setProperty("/interlocutores/RE/Cliente/Ciudad",Ciudad);
            this.getView().getModel().setProperty("/interlocutores/WE/Cliente/Ciudad",Ciudad);
            this.getView().getModel().setProperty("/interlocutores/RG/Cliente/Ciudad",Ciudad);
            this.getView().getModel().setProperty("/interlocutores/AG/Cliente/Ciudad",Ciudad);
            /*interlocutores
                    "AG": {
                        "Cliente": {
        ...
        onBtnGuardarDocumento1: function () {
            ...
            console.log("Nuevo Documento///"+nuevoDocumento+"\n Lista MatJson///"+listaMatJson+"\n Lista listaDsctoJson///"+listaDsctoJson+
                    "\n Lista listaRepJson///"+listaRepJson+"\n Lista listaIntJson///"+listaIntJson+"\n Lista listaPedJson///"+listaPedJson+"\n Lista listadatosCliente///"+listadatosCliente+"\n Lista listaPlanFacturacion///"+listaPlanFacturacion);

            documentosServices.guardarDocumento(nuevoDocumento,listaMatJson,listaDsctoJson,
                    listaRepJson,listaIntJson,listaPedJson,listadatosCliente,listaPlanFacturacion,function(result){
                        sap.ui.core.BusyIndicator.show(0);
                    if (result.c === "s") {
                        if (result.data.success) {
                            ...
                            window.impDoc = true;
                            self.getView().getModel().refresh();
                            /*if(this.getView().getModel().getProperty("/documentoNuevo/Codigo")=="Z001"){
                                self.getView().byId("txt_aviso_general").setText("lb_mensajeAvisoPedidoCreado"+"¿Seguro que el cliente recoge?");
                                sap.ui.getCore().byId("dlg_MensajeAvisoPedidoCreado").open();
                            }else{
        ...
        onNoMensajeAvisoStock:function(){
        ...
        console.log("Agregar nuevo master productos");
...
setTimeout(function () {
        ...
        onMasterProductoSeleccionarMaterial: function (oEvent) {
            ...
            //////Inicio Stock////////////////////////////////////////////////////////
                    /*
            if(this.getView().getModel().getProperty("/pedido/NumPedido")!="" ){
            if(!this.getView().getModel().getProperty("/listaMaterial/"+numb+"/stockDetallado")){
                ...
                materialSeleccionado["ext-comp-1159"] = this.convertirFechaSistema(material.FechaCantConfStr);  //2017-07-19T05:00:00.000Z
                ...
                materialSeleccionado.auart = this.getView().getModel().getProperty("/documentoNuevo/Codigo");  //ZO01
                materialSeleccionado.verStock = 0;  //0
                materialSeleccionado.numPedido = this.getView().getModel().getProperty("/pedido/NumPedido");  //0020165432
            ...
            var result = materialServices.stockDisponibleListaMateriales(materialSeleccionado);
                            ...
                            if (result.c === "s") {
                                if (result.data.success) {
                                    this.getView().getModel().setProperty("/listaMaterial/"+numb+"/stockDetallado", result.data.lstLoteTotal);
                                        this.getView().getModel().refresh();
                                    } else {
                                        sap.m.MessageToast.show(result.data.errors.reason, {
                                            duration: 3000
            ...
            this.getView().getModel().refresh();
            this.getView().getModel().getProperty("/listaMaterial");
...
setTimeout(function(){
  ...
  /***************************Plan de Facturacion *****************************/
        ...
        onSelectItemTipoDoc:function(){
            var tipoDocEscogido = sap.ui.getCore().byId("ListaDocNuevo").getSelectedItem().getBindingContext().getObject();
            this.getView().getModel().setProperty("/tipoDocEscogido",tipoDocEscogido.Codigo);
            if (tipoDocEscogido.Codigo=="Z036") 
            {
                sap.ui.getCore().byId("cbo_tipo_visita").setEnabled(true);
                this.getView().byId("com_tipoVisita_proyectoVisita").setEnabled(false)
            }
            else
            {
                sap.ui.getCore().byId("cbo_tipo_visita").setEnabled(false);
                this.getView().getModel().setProperty("/pedido/TipoVisita","");   
            }
        },
        ...
        goPosicioMaterialUp:function(){
            ...
            if(window.matSeLecDsctos==matSelected.length){
                ...
                return MessageToast.show("No hay mas Posiciones");
            }
            if(matSelected.length>0){
                    var path = matSelected[window.matSeLecDsctos].getBindingContext().getPath();
                    var material = this.getView().getModel().getProperty(path);
        ...
        /*onSiDlg_MensajeAvisoPedidoCreado:function(){
            sap.ui.getCore().byId("dlg_MensajeAvisoPedidoCreado").close();
            this.onOkDlg_MensajeAvisoGeneral();
        },
        onNoDlg_MensajeAvisoPedidoCreado:function(){
            sap.ui.getCore().byId("dlg_MensajeAvisoPedidoCreado").close();
            this.onOkDlg_MensajeAvisoGeneral();
        },*/
...
//--------------------------
        ...
        onVolverCate01: function () {
            sap.ui.getCore().byId("dlg_categoria_01").close();
        },
        onVolverCate02: function () {
            sap.ui.getCore().byId("dlg_categoria_02").close();
        },
        onVolverCate03: function () {
            sap.ui.getCore().byId("dlg_categoria_03").close();
        },
        onVolverCate04: function () {
            sap.ui.getCore().byId("dlg_categoria_04").close();
        },
        onVolverCate05: function () {
            sap.ui.getCore().byId("dlg_categoria_05").close();
        },
        onVolverCate06: function () {
            sap.ui.getCore().byId("dlg_categoria_06").close();
        },
        onVolverCate07: function () {
            sap.ui.getCore().byId("dlg_categoria_07").close();
        },
        onVolverCate09: function () {
            sap.ui.getCore().byId("dlg_categoria_09").close();
        },
        onVolverCate11: function () {
            sap.ui.getCore().byId("dlg_categoria_11").close();
        },
        onVolverCate14: function () {
            sap.ui.getCore().byId("dlg_categoria_14").close();
        },
        onVolverCate15: function () {
            sap.ui.getCore().byId("dlg_categoria_15").close();
        },
        show4000_0: function () {
            this.showBusyIndicator(4000, 0);
        },
