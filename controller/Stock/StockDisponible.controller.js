    ...
    return Controller.extend("pe.com.seidor.sap.decor.ventas.controller.Stock.StockDisponible", {
        ...
        onRouteMatched: function (oEvent) {
            ...
            if (oEvent.getParameter("name") == "appStockDisponible") {
                ...
                var tituloStockDisp = sessionStorage.tituloDocumentoStockDisp==undefined || sessionStorage.tituloDocumentoStockDisp=="undefined"? "":JSON.parse(sessionStorage.tituloDocumentoStockDisp);
                   if(tituloStockDisp==""){
                    ...
                    sap.ui.getCore().byId("dlg_DocNuevobuscar").open();
                                ...
                                this.getView().getModel().setProperty("/pedido",JSON.parse((sessionStorage.pedidoStockDisp==undefined)? "":sessionStorage.pedidoStockDisp));
                                this.getView().getModel().setProperty("/listaMaterial",JSON.parse((sessionStorage.listaMaterialStockDisp==undefined)? "":sessionStorage.listaMaterialStockDisp));
                                this.getView().getModel().setProperty("/interlocutores",JSON.parse((sessionStorage.interlocutoresStockDisp==undefined)? "":sessionStorage.interlocutoresStockDisp));
                                
                                this.getView().getModel().setProperty("/tituloDocumento",JSON.parse((sessionStorage.tituloDocumentoStockDisp==undefined)? "":sessionStorage.tituloDocumentoStockDisp));
                                this.getView().getModel().setProperty("/NumeroDocumentoReferencia",JSON.parse((sessionStorage.NumeroDocumentoReferenciaStockDisp==undefined)? "":sessionStorage.NumeroDocumentoReferenciaStockDisp));
                                this.getView().getModel().setProperty("/listaLinea",JSON.parse((sessionStorage.listaLineaStockDisp==undefined)? "":sessionStorage.listaLineaStockDisp));
                                this.getView().getModel().setProperty("/listaMarca",JSON.parse((sessionStorage.listaMarcaStockDisp==undefined)? "":sessionStorage.listaMarcaStockDisp));
                                this.getView().getModel().setProperty("/listacaract",JSON.parse((sessionStorage.listacaractStockDisp==undefined)? "":sessionStorage.listacaractStockDisp));
                                this.getView().getModel().setProperty("/documentoNuevo",JSON.parse((sessionStorage.documentoNuevoStockDisp==undefined)? "":sessionStorage.documentoNuevoStockDisp));
                                
                                this.getView().getModel().setProperty("/observaciones",JSON.parse((sessionStorage.observacionesStockDisp==undefined)? "":sessionStorage.observacionesStockDisp));
                                
                                this.getView().getModel().setProperty("/cliente",JSON.parse((sessionStorage.clienteStockDisp==undefined)? "":sessionStorage.clienteStockDisp));
                                this.getView().getModel().setProperty("/clienteEventual",JSON.parse((sessionStorage.clienteEventualStockDisp==undefined)? "":sessionStorage.clienteEventualStockDisp));
                                this.getView().getModel().setProperty("/preguntas",JSON.parse((sessionStorage.preguntasStockDisp==undefined)? "":sessionStorage.preguntasStockDisp));
                                
                                this.getView().getModel().setProperty("/busquedaCliente",JSON.parse((sessionStorage.busquedaClienteStockDisp==undefined)? "":sessionStorage.busquedaClienteStockDisp));
                                this.getView().getModel().setProperty("/planFacturacion",JSON.parse((sessionStorage.planFacturacionStockDisp==undefined)? "":sessionStorage.planFacturacionStockDisp));
                                this.getView().getModel().setProperty("/visita",JSON.parse((sessionStorage.visitaStockDisp==undefined)? "":sessionStorage.visitaStockDisp));
                                
                                /*this.getView().getModel().setProperty("/lstGrupoForAnt",JSON.parse(sessionStorage.lstGrupoForAntStockDisp));
                                this.getView().getModel().setProperty("/lstGrupoFor",JSON.parse((sessionStorage.lstGrupoForStockDisp==undefined)? "":sessionStorage.lstGrupoForStockDisp));
                                this.getView().getModel().setProperty("/lstTipoFor",JSON.parse((sessionStorage.lstTipoForStockDisp==undefined)? "":sessionStorage.lstTipoForStockDisp));*/
                                this.getView().getModel().setProperty("/lstGrupoForAnt",(sessionStorage.lstGrupoForAntStockDisp==undefined || sessionStorage.lstGrupoForAntStockDisp=="undefined")? "":JSON.parse(sessionStorage.lstGrupoForAntStockDisp));
                                    this.getView().getModel().setProperty("/lstGrupoFor",(sessionStorage.lstGrupoForStockDisp==undefined || sessionStorage.lstGrupoForStockDisp=="undefined")? "":JSON.parse(sessionStorage.lstGrupoForStockDisp));
                                    this.getView().getModel().setProperty("/lstTipoFor",(sessionStorage.lstTipoForStockDisp==undefined || sessionStorage.lstTipoForStockDisp=="undefined")? "":JSON.parse(sessionStorage.lstTipoForStockDisp));
        ...
        sessionStorageDocNuevo: function(){
            sessionStorage.setItem("tituloDocumentoStockDisp",JSON.stringify(this.getView().getModel().getProperty("/tituloDocumento")));
            sessionStorage.setItem("NumeroDocumentoReferenciaStockDisp",JSON.stringify(this.getView().getModel().getProperty("/NumeroDocumentoReferencia")));
            sessionStorage.setItem("listaLineaStockDisp",JSON.stringify(this.getView().getModel().getProperty("/listaLinea")));
            sessionStorage.setItem("listaMarcaStockDisp",JSON.stringify(this.getView().getModel().getProperty("/listaMarca")));
            sessionStorage.setItem("listacaractStockDisp",JSON.stringify(this.getView().getModel().getProperty("/listacaract")));
            sessionStorage.setItem("documentoNuevoStockDisp",JSON.stringify(this.getView().getModel().getProperty("/documentoNuevo")));
            sessionStorage.setItem("pedidoStockDisp",JSON.stringify(this.getView().getModel().getProperty("/pedido")));
            sessionStorage.setItem("observacionesStockDisp",JSON.stringify(this.getView().getModel().getProperty("/observaciones")));
            sessionStorage.setItem("interlocutoresStockDisp",JSON.stringify(this.getView().getModel().getProperty("/interlocutores")));
            sessionStorage.setItem("clienteStockDisp",JSON.stringify(this.getView().getModel().getProperty("/cliente")));
            sessionStorage.setItem("clienteEventualStockDisp",JSON.stringify(this.getView().getModel().getProperty("/clienteEventual")));
            sessionStorage.setItem("preguntasStockDisp",JSON.stringify(this.getView().getModel().getProperty("/preguntas")));
            sessionStorage.setItem("listaMaterialStockDisp",JSON.stringify(this.getView().getModel().getProperty("/listaMaterial")));
            sessionStorage.setItem("busquedaClienteStockDisp",JSON.stringify(this.getView().getModel().getProperty("/busquedaCliente")));
            sessionStorage.setItem("planFacturacionStockDisp",JSON.stringify(this.getView().getModel().getProperty("/planFacturacion")));
            sessionStorage.setItem("visitaStockDisp",JSON.stringify(this.getView().getModel().getProperty("/visita")));
            sessionStorage.setItem("lstGrupoForAntStockDisp",JSON.stringify(this.getView().getModel().getProperty("/lstGrupoForAnt")));
            sessionStorage.setItem("lstGrupoForStockDisp",JSON.stringify(this.getView().getModel().getProperty("/lstGrupoFor")));
            sessionStorage.setItem("lstTipoForStockDisp",JSON.stringify(this.getView().getModel().getProperty("/lstTipoFor")));
        ...
        validProveedor:function(){
            ...
            if(usu_ser=="X")
            {
                ...
                this.getView().byId("txtDetBusMatNoProveedor").setVisible(false);
                this.getView().byId("txtDetBusMatProveedor").setVisible(true);
        ...
        initView: function () {
            if(sessionStorage.listaMaterialStockDisp==undefined){
...
setTimeout(function(){
            ...
            if (result.c === "s") {
                if (result.data.success) {
                    ...
                    self.getView().getModel().setProperty("/pedido/FechaReparto",utilString.obtenerFechaDespacho(self.getView().getModel().getProperty("/pedido/FechaPedido"))) ;
                    sap.ui.core.BusyIndicator.hide();
                    //self.validCamposDoc();
...
setTimeout(function () {
    ...
    MessageToast.show("Ingrese codigo de proveedor");
        ...
        onBtnRecalcular:function(){
            ...
            if(materiales){
                if(materiales.length > 0) {
                    ...
                    sap.ui.core.BusyIndicator.show(0);
                    setTimeout(function(){
                        /*var result = materialServices.recalcularModificar(op,estadoView,numPedido,dsctoLotes, listaInter, listaDscto, listaRepartos, 
        ...
        crearPedidoConReferencia: function() {
            ...
            pedido.textoContacto = "";//visitaMod.textoContacto;
            pedido.textoDatosAdicionalesCliente = "";//visitaMod.textoDatosAdicionalesCliente;
            pedido.textoTelefonos = "";//visitaMod.textoTelefonos;
            pedido.textoDescripcionVisita = "";//visitaMod.textoDescripcionVisita;
            pedido.textoResultadoVisita = "";//visitaMod.textoResultadoVisita;
        ...
        crearInterlocutoresConReferencia: function() {
            ...
            for(var indice in listInter) {
                ...
                interlocutor.Direccion = interlocutores[listInter[indice]].Cliente.Direccion ;
                interlocutor.DireccionCompleta = interlocutores[listInter[indice]].Cliente.Direccion + " " + interlocutores[listInter[indice]].Cliente.CodigoPostal + " " +  interlocutores[listInter[indice]].Cliente.Ciudad ;
                interlocutor.Ciudad = (interlocutores[listInter[indice]].Cliente.Ciudad ==null) ? "":interlocutores[listInter[indice]].Cliente.Ciudad //this.getView().byId("com_distrito_solicitante").getSelectedItem().getText();
                interlocutor.Pais = interlocutores[listInter[indice]].Cliente.Pais ;
                interlocutor.CodigoPostal = interlocutores[listInter[indice]].Cliente.CodigoPostal ;
                                ...
                                /*if(window.dataIni.person.CanalDist=="10"){
                                        if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z001" ||
                                            ...
                                            this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z004" ){
                                                var ValidDsctoPri = materialMod.DescuentoPrincipal.filter(function(el) {
                                                                         return el.Condicion == "ZD00" || el.Condicion == "ZD04" || el.Condicion == "ZD09" || el.Condicion == "ZD11" || el.Condicion == "ZDCT" || el.Condicion == "ZD13";
                                                                });
                                                                materialMod.DescuentoPrincipal = ValidDsctoPri;
                                            }
                                    ...
                                    if(window.dataIni.person.CanalDist=="20"){
                                        if(window.dataIni.person.OfVentas=="1040"){
                                            if(this.getView().getModel().getProperty("/pedido/CodTipoDoc")=="Z002"){
                                                var ValidDsctoPri = materialMod.DescuentoPrincipal.filter(function(el) {
                                                                         return el.Condicion == "ZD00" || el.Condicion == "ZD04" || el.Condicion == "ZD09" || el.Condicion == "ZD11" || el.Condicion == "ZD02";
                                                                });
                                                                materialMod.DescuentoPrincipal = ValidDsctoPri;
                                            }
                                        }
...
setTimeout(function(){
            ...
            //var result = documentosServices.guardarDocumentoModificar(nuevoDocumento,listaMatJson,listaDsctoJson,listaRepJson,listaIntJson,listaPedJson,listadatosCliente,listaPlanFacturacion);
            documentosServices.guardarDocumento(nuevoDocumento,listaMatJson,listaDsctoJson,listaRepJson,listaIntJson,listaPedJson,listadatosCliente,listaPlanFacturacion, function(result) { 
                sap.ui.core.BusyIndicator.show(0);
            if (result.c === "s") {
                if (result.data.success) {
...
sap.ui.core.BusyIndicator.hide();
        ...
        onDocNuevoMasterProductosAddonDialog: function () {
            ...
            if(!documentoCreado){
                ...
                this.getView().byId("listPanelDatos").setVisible(true);
                sap.ui.getCore().byId("dlg_DocNuevoaddProductoonDialog").close();
                return sap.ui.getCore().byId("dlg_MensajeAvisoCrearCotizacion").open();
            }
        ...
        onCrearCotizacion: function (oEvent) {
            ...
            if (result.c === "s") {
                if (result.data.success) {
                    ...
                    var titulo = "Creando Documento "+tipoDocumento.Codigo;
            self.getView().getModel().setProperty("/tituloDocumento",titulo);
                        //sap.ui.getCore().byId("dlg_MensajeAviso1").open();
                } else {
                    sap.ui.core.BusyIndicator.hide();
                    sap.m.MessageToast.show(result.data.errors.reason, {duration: 3000});
...
setTimeout(function () {
  ...
  /***************************Plan de Facturacion *****************************/
        ...
        onDocPlanFactuacionAdd: function(evt) {
            ...
            var subTotal = this.getView().getModel().getProperty("/pedido/SubTotal");
            var subTotalN = (utilString.isNumeric(subTotal)) ? subTotal : parseFloat(subTotal);
                                            ...
                                            //////////////////////////
                                                if(descuentoPrin.Valor=="0" || descuentoPrin.Valor==0 || descuentoPrin.Valor==""){
                                                    ...
                                                    if(this.getView().getModel().getProperty(path+"/CodMaterialCorto")=="20000815" || this.getView().getModel().getProperty(path+"/CodMaterialCorto") =="20000182"){
                                                        ...
                                                        this.getView().getModel().setProperty(path+"/Vdscto",descuentoPrin.Importe);
                                                    }
                                                }
                                            //////////////////////////
                                            listaDescPrinFinal.push(descuentoPrin);
                                            ...
                                            //////////////////////////
                                                if(descuentoOtros.Valor=="0" || descuentoOtros.Valor==0 || descuentoOtros.Valor==""){
                                                    ...
                                                    if(this.getView().getModel().getProperty(path+"/CodMaterialCorto")=="20000815" || this.getView().getModel().getProperty(path+"/CodMaterialCorto") =="20000182"){
                                                        ...
                                                        this.getView().getModel().setProperty(path+"/Vdscto",descuentoOtros.Importe);
                                                    }
                                                }
                                            //////////////////////////
                                            listaDescOtrosFinal.push(descuentoOtros);
        ...
        onDocNuevoClosedlg_buscar: function () {
            ...
            if(this.getView().getModel().getProperty("/tituloDocumento")!=""){
                sap.ui.getCore().byId("dlg_DocNuevobuscar").close();
            }else{
                utilString.destruirFragments(this);
                sessionStorage.clear();
